                    ...
                    <div class="card-body">
                        <div class="card-block">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tipo-documento-tab" data-toggle="tab" href="#link_tipo_documento"
                                       aria-controls="link_tipo_documento"
                                       aria-expanded="false">Tipo Documento</a>
                                </li>
                            ...
                            <div class="tab-content px-1 pt-1">
                                ...
                                <!--tipo documento-->
                                  <div class="tab-pane fade" id="link_tipo_documento" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"
                                                   for="pay_cat">Tipo Documento</label>

                                            <div class="col-sm-6">
                                                <select name="trans_type" class="form-control" id="sel_tipo_documento">
                                                    <option value=''>Todos</option>
