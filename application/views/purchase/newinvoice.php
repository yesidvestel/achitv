                ...
                <form method="post" id="data_form">
                            ...
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12"><h3
                                                class="title"><?php echo $this->lang->line('Order Properties') ?> </h3>
                                    </div>

                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno"
                                                                 class="caption"><?php echo $this->lang->line('') ?>Numero de Orden </label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control" name="taxformat"
                                            ...
                                            <?php if ($this->config->item('tax') == 1) {
                                                ...
                                                echo '<option value="off">&raquo;' . $this->lang->line('') . '</option>';
                                            } ?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" onchange="changeDiscountFormat(this.value)"
                                                	...
                                                	<option value="flat"><?php echo $this->lang->line('').' '.$this->lang->line('')  ?>Descuento despues de impuesto</option>
                                                  	<option value="b_p"><?php echo $this->lang->line('').' '.$this->lang->line('')  ?>Descuento antes de impuesto</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="toAddInfo"
                                               class="caption"><?php echo $this->lang->line('') ?>Observaciones</label>
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            </tr> <tr><td colspan="8"><textarea id="dpid-0" class="form-control" name="product_description[]" placeholder="<?php echo $this->lang->line('Enter Product description'); ?>" autocomplete="off"></textarea><br></td></tr>
