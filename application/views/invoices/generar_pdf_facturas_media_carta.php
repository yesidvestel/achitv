    ...
    <table id="t-titulo" width="100%"  align="center" >
        <tbody>
            <tr>
                ...
                <td><img  src="<?="userfiles/company/1653342787453430262.png"  ?>"></td>
            </tr>
            <tr>
                <td><h1 >Facturas  </h1>
                <h3 > <?=$sede." - ".$fecha  ?></h3>
...
<!-- Inicio Factura-->
    <!-- Encabezado-->
        ...
        <div id="saludo"  ><h4>Sr(a) <?=$custmr->name." ".$custmr->dosnombre." ".$custmr->unoapellido." ".$custmr->dosapellido ?></h4>
            ...
            <h6>Direccion : <?= $custmr->nomenclatura . ' ' . $custmr->numero1 . $custmr->adicionauno.' Nº '.$custmr->numero2.$custmr->adicional2.' - '.$custmr->numero3." ".$custmr->referencia."- Br:".$barrio->barrio.", ".$sede; ?></h6>
        ...
        <div id="logo-div"> <img class="logo_i" src="<?="userfiles/company/1.jpeg"  ?>"><img class="logo_i" src="<?="userfiles/company/2.jpeg"  ?>"></div>
    <!-- Encabezado-->
    <br>
    <!--Cuerpo Facturas-->
...
?>
                        ...
                        <div class="datos_empresa" >
                            <p class="p_datos_empresa">
                                <b><i>Apreciado Cliente. Recuerda que la fecha limite de pago son los (5) de cada mes y la fecha de suspension los (6) de cada mes. Evita el costo por reconexión. 
Achitel SAS comprometidos por el progreso del pueblo.</i></b><br>
