...
<script type="text/javascript">
    ...
    $("#enviar").click(function(ev){
        ...
        var sdate=$("#sdate2").val();
         progress_one(40);
        $.post(baseurl+"facturasElectronicas/lista_facturas_a_borrar",{'pay_acc':pay_acc,'sdate':sdate},function(data){
            progress_one(90);
...
function iniciar_facturacion(){
        ...
        progress_one(10);
        if(i<parseInt(total)){
            var id_inv=datos_recorrer[i].id_invoice;
             //var num1=va_en+1;
             va_en++;
                ...
                $('#progress').LineProgressbar({
                    ...
                    $("#span_progress1").text(va_en+"/"+total_a_facturar);
                    progress_one(40);
            $.post(baseurl+"facturasElectronicas/procesar_invoice_a_borrar",{'pay_acc':pay_acc,'sdate':sdate,'id_inv':id_inv},function(data){
                console.log(i);
